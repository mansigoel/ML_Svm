...
try:
    print "for Cval = " + str(best['C']) + " accuracy is "
    all1.append([str(best['C'])])

    clf = OneVsRestClassifier(SVC(probability=False,cache_size=200,kernel="rbf", max_iter = 10000, gamma=best['gamma'], C=best['C']),-1)
    ...
    val1,val2,val3 = generate_roc(smatrix,Ytbest,nROCpts =100 ,plotROC = 'true', name= 'Roc_1(c).png')
...
with open('analysis(1c).csv', 'w') as fp:
